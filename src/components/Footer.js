  ...
  return (
    <div class="  z-50 relative bg-[#1A1F2C]">
      ...
      <footer className="bg-[#1A1F2C] pt-20">
        ...
        {/* Copyrights */}
        <div className=" relative bg-[#13103e] bg-opacity-20 flex w-full">
          ...
          <div
            className="md:h-16 h-12 bottom-2 right-2 md:right-5 absolute bg-cover text-neon-100 md:bottom-0 cursor-pointer filter bg-neon-100 rounded-full animate-bounce bg-no-repeat aspect-square"
            style={{
