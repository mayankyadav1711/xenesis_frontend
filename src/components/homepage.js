    ...
    return (
      ...
      >
        ...
        <div className="z-30 absolute top-1/2 -translate-y-1/2 px-[calc(3vh)] w-1/2 left-5">
          <h1 className="text-[calc(8vh)] text-transparent bg-gradient-to-r from-blue-600 via-white to-green-600 uppercase font-bold w-fit bg-clip-text font-mono">
        ...
        {Object.entries(departmentEvents).map(([department, events]) => (
          <div key={department} className={`bg-[#070d15]`}>
            <div className="w-full text-center">
              <h3 className="uppercase text-white text-heading5 font-serif font-semibold mb-4  pt-4">
                {department}
              </h3>
            </div>
      ...
      {/* Gallery */}
      <div
        className="overflow-x-hidden bg-cover bg-no-repeat bg-center bg-darkBlue-50 backdrop-filter py-10 "
        // style={{
        //   backgroundImage:
        //     "url('https://res.cloudinary.com/db4e3hqfv/image/upload/v1706210889/chandrayaan-3-soft-landing-moon-with-indian-flag_816702-1971_psmstb.jpg",
        // }}
      >
        <div className="absolute inset-0 bg-[#070d15b5] backdrop-filter backdrop-blur-3xl"></div>
        <div className="w-full text-center">
          <h3 className="uppercase text-white text-heading5 font-serif font-semibold  pb-6">
            Gallery
          </h3>
        </div>
        <Swiper
          className="p-20 swiper-container-glass"
