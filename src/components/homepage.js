    ...
    <div class=" overflow-x-hidden">
      ...
      <div className="bg-[#070d15]">
        <div className="w-full text-center">
          <h3 className="uppercase text-white lg:text-[calc(8vh)] text-[calc(3vh)] font-serif font-semibold pb-4 pt-4">
            Departments
          </h3>
        </div>
      </div>
      ...
      <div className="bg-[#162238]]">
        {Object.entries(departmentEvents).map(([department, events]) => (
          <div key={department} className={`bg-[#070d15]`}>
            <div className="w-full text-center">
              <h3 className="uppercase text-white lg:text-[calc(8vh)] text-[calc(3vh)] font-serif font-semibold mb-4  pt-4">
                {department}
              </h3>
            </div>
