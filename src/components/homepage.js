...
const Home = () => {
  ...
  const departments = [
    [
      "Department 1",
      "https://firebasestorage.googleapis.com/v0/b/studymate-c44e8.appspot.com/o/com.png?alt=media&token=de93b4dd-4592-4db2-9be5-76d52ae97d2c",
    ],
    [
      "Department 2",
      "https://firebasestorage.googleapis.com/v0/b/studymate-c44e8.appspot.com/o/com.png?alt=media&token=de93b4dd-4592-4db2-9be5-76d52ae97d2c",
  ...
  return (
    <div className={`${theme.backgroundGradient} overflow-x-hidden`}>
      <nav
        class="flex items-center overflow-visible justify-between text-white fixed w-full top-0 pt-[calc(2vh)] pb-10 px-[calc(3vh)] z-50 transition-all duration-300"
        id="navbar"
      >
        <a href="/">
          <img
            src="https://firebasestorage.googleapis.com/v0/b/studymate-c44e8.appspot.com/o/logoCus.png?alt=media&token=235dd869-9cdb-4150-b917-315651f74159"
            class="h-16 w-auto"
          />
        </a>
        <ul class="flex items-center">
          <li class="mx-[calc(2vh)] py-2 font-semibold text-[calc(3vh)] hover:text-[#bc85ff] transition-all duration-300 border-transparent border-4 hover:border-b-[#bc85ff]">
            <a href="/">Home</a>
          </li>
          <li class="mx-[calc(2vh)] py-2 font-semibold text-[calc(3vh)] hover:text-[#bc85ff] transition-all duration-300 border-transparent border-4 hover:border-b-[#bc85ff]">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://firebasestorage.googleapis.com/v0/b/studymate-c44e8.appspot.com/o/landingPage.png?alt=media&token=d64ecdf0-44fe-4f26-9d1c-3930b4369386')",
      ...
      >
        ...
        <div className="z-30">
          <h1
            className="text-[calc(8vh)] text-white uppercase font-bold bg-gradient-to-r from-orange-500 via-white to-green-500 w-fit bg-clip-text text-transparent"
            data-aos="fade-up"
          >
            Xenesis
          </h1>
          ...
          <p
            className="text-[calc(3vh)] text-white uppercase font-bold bg-gradient-to-r from-orange-500 via-white to-green-500 w-fit bg-clip-text text-transparent font-['Tiro_Devanagari_Hindi','serif']"
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <p
            className="text-[calc(2vh)] my-2 font-bold bg-gradient-to-r from-orange-500 via-white to-green-500 w-fit bg-clip-text text-transparent"
            data-aos="fade-up"
            data-aos-delay="200"
          >
      ...
      <div className="w-full h-fit customScrollbar relative my-5">
        <div className="flex flex-col items-center justify-center w-full mb-5">
          ...
          <p className="text-gray-500 text-center my-3 mx-auto w-[500px]">
            Take a look at the events organized by our students and feel free to
            register in any event you want to.
          </p>
        </div>
          ...
          <div className="swiper-wrapper h-fit">
            {eventArr.map((event, index) => (
              ...
              >
                <div
                  data-aos="zoom-in"
                  className="bg-[#AAABE2]/50 backdrop-blur-md rounded-lg group overflow-hidden"
                  id={`event-${index}`}
                >
                  <div className="bg-[#2F1D69]/50 w-full h-full absolute top-full z-30 rounded-lg flex flex-col justify-between transition-all duration-300">
                    <div className="px-4 pt-5">
                      <div className="flex items-center justify-between">
                        <h1 className="text-white font-bold text-xl capitalize eventName title-truncate max-w-[85%]">
                          {event.title}
                        </h1>
                        <svg
                          ...
                          viewBox="0 0 16 16"
                          onClick={() =>
                            handleCardOverlayClose(`event-${index}`)
                          }
                        >
                      ...
                      <hr className="my-3" />
                      <h2 className="discription-truncate text-white">
                        {event.description}
                      </h2>
                      <div className="my-1 flex items-center justify-between">
                        <div className="flex flex-col">
                          {event.pricePerHead !== "-" ? (
                            <p className="text-white my-1 capitalize text-green-500">
                        ...
                        <div className="flex items-center gap-2">
                          <svg
                            ...
                            viewBox="0 0 16 16"
                            id={`likeSVG-${index}`}
                            onClick={() => handleLike(`event-${index}`)}
                          >
                          ...
                          <svg
                            ...
                            height="16"
                            fill="#ff0000"
                            className="bi bi-heart-fill hidden opacity-0 cursor-pointer eventName"
                            viewBox="0 0 16 16"
                            id={`likeFillSVG-${index}`}
                            onClick={() => handleLike(`event-${index}`)}
                          >
                            <path
                              fillRule="evenodd"
                    ...
                    <div
                      className="bg-[#2F1D69] px-4 py-2 text-center cursor-pointer"
                      onClick={() =>
                        (window.location.href = `/event/${event.eventId}`)
                      }
                    >
                      <a className="text-white capitalize text-lg font-bold">
                        register
                      </a>
                    </div>
                  </div>
                  <div className="" id={`blurOverlay-${index}`}>
                    <div className="w-full rounded-t-lg overflow-hidden relative group">
                      <img
                        ...
                        alt="1"
                        className="group-hover:scale-110 h-48 w-full object-cover overflow-hidden transition-all duration-300"
                      />
                    </div>
                    <div className="my-3 px-4">
                      <h1 className="text-white font-bold text-2xl capitalize eventName title-truncate">
                        {event.title}
                      </h1>
                      <div className="flex items-center justify-between my-4">
                        <div className="flex flex-col">
                          {event.pricePerHead !== "-" ? (
                            <p className="text-[#2F1D69] text-lg font-semibold rounded-lg capitalize w-fit">
                              ₹{event.pricePerHead} per head
                            </p>
                          ) : (
                            <p className="text-[#2F1D69] text-lg font-semibold rounded-lg capitalize w-fit">
                        ...
                        <a
                          className="bg-[#2F1D69] text-white font-semibold px-2 py-1 rounded-lg cursor-pointer"
                          onClick={() =>
                            handleCardOverlayClose(`event-${index}`)
                          }
                        >
                    ...
                    <div className="flex items-center justify-center bg-[#2F1D69] h-14 px-2 -pt-10 pb-0 rounded-b-lg relative">
                      <div className="flex flex-col items-center absolute bottom-0 z-20 -translate-x-[50%]">
                        ...
                        <p className="bg-yellow-500 px-4 py-2 text-white font-semibold transition-all duration-300 hover:py-4">
                          ₹ 1000
                        </p>
                      </div>
                      <div className="flex flex-col items-center absolute bottom-0 translate-x-[50%] z-10">
                        ...
                        <p className="bg-gray-500 px-4 py-[3px] text-white font-semibold transition-all duration-300 hover:py-4">
                          ₹ 750
                        </p>
                      </div>
                    </div>
        ...
        <div className="w-full flex items-center justify-center my-5">
          <a
            href="/events"
            className="bg-white/20 text-white px-6 py-2 font-bold rounded-md transition-all duration-300"
          >
            See More
          </a>
        </div>
