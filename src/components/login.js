            ...
            <div className="relative flex items-center justify-center w-screen h-full min-h-[100vh] py-20 overflow-hidden">
                ...
                <div className="flex items-center lg:justify-end md:pt-0 pt-5 justify-center w-[80%] h-full">
                    <form
                        action="/login/"
                        method="post"
                        className="form max-w-[500px] w-full lg:w-[90%] h-full md:px-12 sm:px-10 px-8 lg:py-12 sm:py-11 py-10 backdrop-blur-md bg-slate-800 bg-opacity-15 shadow-inner border-solid border-x-4  border-neon-100 z-10 rounded-xl"
                        autoComplete="off">
                        {/* CSRF Token */}
                    ...
                    invalid:border-pink-300 invalid:text-red-400 focus:invalid:border-pink-300"
                                ...
                                <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    className="bi bi-eye absolute right-2 bottom-2 text-neon-100 hidden"
                                    id="eyeOpen"
                                    viewBox="0 0 16 16"
                                    onClick={toggleEye}>
                                ...
                                <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    className="bi bi-eye-slash absolute right-2 bottom-2 text-neon-100"
                                    viewBox="0 0 16 16"
                                    id="eyeClosed"
                                    onClick={toggleEye}>
