                            ...
                            >
                                ...
                                <div className="py-0  px-4 glassy-effect  rounded-lg shadow-outset-black">
                                    ...
                                    <div className="flex flex-col items-center justify-center my-2">
                                        <p className="text-gray-300  font-jost  text-lg  font-semibold rounded-lg capitalize  whitespace-nowrap">
                                            {event.eventPrice !== "-" ? (
                                                <>
                                                    ...
                                                    Team Not Allowed
                                                    <br />
                                                    <FaUser className="inline text-neon-100  font-jost mr-1" />₹{event.eventPrice} per head
                                                </>
                                            ) : (
                                                <></>
                                            )}
                                        ...
                                        {event.isTeamEvent && (
                                            <p className="text-gray-300 font-jost  text-lg font-semibold rounded-lg capitalize  whitespace-nowrap">
                                                <FaUsers className="inline  font-jost text-neon-100 mr-1" />₹{event.teamPrice} per Team
                                            </p>
                                        )}
                                    </div>
                                ...
                                {event.winnerPrice1 !== 0 && event.winnerPrice2 !== 0 && (
                                    ...
                                    >
                                        <div className="flex hover:pb-2.5 duration-300 flex-col bg-[#f0a500] rounded-t-md items-center absolute bottom-0 z-20 -translate-x-[50%]"
                                            ...
                                            <p style={{
                                                // boxShadow: "6px 6px 6px 6px rgba(0, 0, 0, 0.25)",
                                            }} className=" rounded-t-md px-4 py-2 text-darkBlue-50  font-jost font-semibold  ">₹ {event.winnerPrice1}</p>
                                        </div>
                                        <div className="flex hover:pb-2 duration-300 justify-between  bg-gray-400 rounded-t-md flex-col delay-100 items-center absolute bottom-0 translate-x-[50%] z-10"
                                            ...
                                            <p style={{
                                                // boxShadow: "6px 6px 6px 6px rgba(0, 0, 0, 0.25)",
                                            }} className=" rounded-t-md px-4 py-[2px] text-gray-800  font-jost  font-semibold  ">₹ {event.winnerPrice2}</p>
                                        </div>
                                    </div>
                                )}
                            </div>
