  ...
  return (
    ...
    >
          ...
          <div className="border-black border-t-2">
            <div className="grid text-center gap-x-1 px-1 font-bold items-center grid-cols-[40%_1fr_40%]">
              <div className="flex flex-col text-caption2">
                ...
                <p className="py-0.5 p-2 border-t-[1px] line-clamp-1 border-black">
                  FEB'24
                </p>
              </div>
              <p className="date py-3 p-2 border-l-2 text-subtitle1 border-r-2 font-extrabold border-black">
                23
              </p>
              <div className="flex flex-col text-caption2">
      ...
      <div className=" absolute bottom-0 translate-x-1/2   left-[25%]">
        <div className="h-[15px] w-[30px] bg-black  z-10  rounded-tl-full rounded-tr-full "></div>
      </div>
      <div className=" absolute top-0 translate-x-1/2  left-[25%]">
        <div className="h-[15px] w-[30px] bg-black  z-10  rounded-bl-full rounded-br-full "></div>
      </div>
      {/* <div>
