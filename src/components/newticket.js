    ...
    return (
        ...
        <div className={`flex relative justify-between  items-center bg-white  bg-opacity-75  rounded-md`}>
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-tl-md flex items-center rounded-bl-md h-full w-[50px] left-0">
                <p className="-translate-x-1/4 -rotate-90 text-center font-extrabold">XENESIS'24</p>
            </div>
            <div className="  border-2 w-full rounded-tl-none border-l-0 m-4 ml-0 border-black rounded-bl-none grid grid-cols-[25%_1fr]  items-center  rounded-lg">
                ...
                <div className="flex border-l-8   border-dotted border-[#162238]  flex-col">
                    ...
                    <div className="grid py-4  grid-cols-[30%_1fr] items-center">
                        ...
                        <div className="h-fit gap-0 text-caption1 font-semibold flex-col line-clamp-3     text-black ">
                            ...
                            <p className="font-bold text-caption2 ">ULTIMATE CLASH - FREE FIRE </p>
                        </div>
                    </div>
                    ...
                    <div className="border-black border-t-2">
                        <div className="grid text-center gap-x-1 px-1 font-bold items-center grid-cols-[40%_1fr_40%]">
                            <div className="flex flex-col text-caption1">
                                <p className="py-0.5 p-2  " >FRIDAY</p>
                                <p className="py-0.5 p-2 border-t-[1px] border-black" >FEBRUARY'24</p>
                            </div>
            ...
            <div className=" absolute bottom-0 translate-x-1/2 translate-y-[20px] left-[26.3%]">
                <Dots />
            </div>
            <div className=" absolute top-0 translate-x-1/2 -translate-y-[20px] left-[26.3%]">
                <Dots />
            </div>
        </div>
    );
