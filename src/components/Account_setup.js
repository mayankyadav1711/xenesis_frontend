    ...
    return (
        <div className="relative flex items-center justify-center w-full h-full min-h-[100vh] md:py-10 py-12 overflow-y-scroll">
            ...
            <form
                ...
                className="form max-w-[500px] w-full lg:w-[90%] h-full md:px-10 sm:px-7 px-8 lg:py-12 sm:py-8 py-10 backdrop-blur z-10 rounded-xl">
                ...
                <div class="w-full flex flex-col items-center gap-8 mb-2">
                    ...
                    <div class="flex group relative w-full justify-center font-semibold">
                        <input
                            ...
                            name="firstname"
                            spellCheck="false"
                            class="peer bg-transparent w-full pr-3 pl-1 py-2 transition-all duration-300 outline-none text-white border-b-[1px] border-orange-300
