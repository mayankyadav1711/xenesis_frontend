...
const Aboutus = () => {
  ...
  return (
    <>
      <section
        className="min-h-screen flex-col gap-4 relative"
        style={divStyle}
      >
        <h1
          className={`absolute top-[40%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white lg:text-6xl md:text-4xl sm:text-2xl text-xl font-bold w-full text-center opacity-75 animate-text ${
            isVisible ? "animate" : ""
          }`}
        >
          <span>A</span>
